public class EscapeFromTheSodaLabs extends Trial {
    ...
    /**
     * General Ackbar has discovered treasures in the second floor labs. 
     * However, a nefarious entity, Leorge Gucas
     * has "deployed the algorithm" which is set to destroy the labs. 
     * To save Soda, collect all the treasures in as few
